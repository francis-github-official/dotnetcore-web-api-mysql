...
namespace BlogPost.Models
{
    public class BlogPostQuery
    {
        ...
        public async Task<BlogPostModel> FindOneAsync(int id)
        {
        ...
        public async Task<List<BlogPostModel>> LatestPostsAsync()
        {
            using var cmd = Db.Connection.CreateCommand();
        ...
        private async Task<List<BlogPostModel>> ReadAllAsync(DbDataReader reader)
        {
